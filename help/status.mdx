...
<CardGroup cols={2}>
  <Card title="FAQ" icon="message-circle-question" href="/help/faq">
    Find answers to common questions about Clamly.
  </Card>
  <Card title="Contact support" icon="life-buoy" href="mailto:support@clamly.app">
    Email the Clamly team at support@clamly.app.
  </Card>
</CardGroup>
